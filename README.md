...
- **Cross-Platform Support**: Pre-built wheels for Windows, macOS (Apple Silicon and Intel), and Linux
...
Pre-built binary wheels are available for Python 3.9-3.14 on all major platforms:
...
|----------|----------------|--------------|--------|
| Linux    | 3.9 - 3.14     | x86_64       | ✅ Tested |
| macOS    | 3.9 - 3.14     | arm64 (M1/M2/M3) | ✅ Tested |
| macOS    | 3.9 - 3.14     | x86_64 (Intel)   | ✅ Tested |
| Windows  | 3.9 - 3.14     | x86_64       | ✅ Tested |

> [!NOTE]
> **macOS Intel (x86_64) Support**: Binary wheels for macOS x86_64 (Intel processors) are now provided as of v0.2.4.
> If you have an Intel-based Mac, you can install directly from PyPI:
> ```bash
> pip install kuoeliassen
> ```
